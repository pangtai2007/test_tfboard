...
l2 = add_layer(l1, 10, 7, n_layer=2, activation_function=tf.nn.relu)
prediction = add_layer(l2, 7, 1, n_layer=3, activation_function=None)  # 输出层
...
#    accurary = tf.reduce_mean(tf.cast(tf.equal(ys, prediction), tf.float32))
